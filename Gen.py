...
def generer_mot_de_passe(longueur, difficulte):
...
def main():
    while True:
        ...
        if choix == '1':
            ...
            print(f"{Fore.YELLOW}Mot de passe généré:", generer_mot_de_passe(longueur, difficulte))
        elif choix == '2':
            longueur = int(input("Longueur du pseudonyme: "))
            print(f"{Fore.YELLOW}Pseudonyme généré:", generer_pseudo(longueur))
        elif choix == '3':
